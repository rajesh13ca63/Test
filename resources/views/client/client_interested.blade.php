...
<div class="row" style="background-color:#a0a0a0;">
	@if($cprofiles)
		@foreach($cprofiles as $profile)
			@if($inte->contains($profile->id))
	...
	@endif 
		...
		<div class="row text-right"><div class="pagination" style="clear:both;"> {{  $cprofiles->render() }}</div></div>
</div>
