...
<div class="conatainer" style="margin:0px 0px 0px 0px; background-image:url('/images/bg1.jpg'); padding:50px;">
      ...
      <div class="row">
           ...
           <div class="col-xs-12 col-sm-12 col-md-12 text-right">
            	...
            	<a href="/boutique/interested_jobs" class="userDashboard"><span class="badge" style="font-size:25px;background-color:#0089ca;border:1px solid #004596;">{{ count($bposts)}}</span> Interested Opportunities </a>
                 <a href="/boutique/new_jobs" class="userDashboard"><span class="badge" style="font-size:25px;background-color:#0089ca;border:1px solid #004596;">{{ count($mposts) }}</span> Matching Opportunities </a>
...
<div style="margin-left:10%; width:80%;height:auto;padding-top:0px;">
        ...
        <div class="row" >
          <form class="text-center"action ="/searching/opportunities" method="POST" style="margin:0px 0px 20px 0px;width:100%;padding:20px;height:70px;">
