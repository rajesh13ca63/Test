...
<div class="container1" style="margin-top:35px;">
    ...
    <div class="card1">
            ...
            <form action="/admin/create/post" method="POST" class="form-horizontal form1" enctype="multipart/form-data">
            ...
            <div class="form-group" style="margin-top:15px;">
                <div class="col-sm-3 text-right" style="margin-top:0px; margin-left:20px;">
                    <div style="font-size:15px; color:#808080;text-decoration:bolder;padding-top:10px;margin-top:5px;">Experience(in years) :</div>
                </div>
            ...
            <div style="width:80%;margin:15px 0px 15px 32px;font-size:15px; text-decoration:bolder;">
                <div style="text-decoration:bolder;color:#808080;"> 
                Type of Opportunity: </div>
                <select name="Type_of_opportunity" id="Consulting" value="{{ old('Type_of_opportunity') }}" style="height:35px; width:40%;" >
            ...
            <div class="form-group">
                <div class="col-sm-2 col-sm-offset-0" style="margin-top:6px; margin-left:30px ">
                    <div style="width:80%;font-size:15px; color:#808080;text-decoration:bolder;">Rate </div>
                </div>
                ...
                @endif
                <div class="col-sm-5">
                      <select name="J2w_duration" id="Consulting" value="{{ old('J2w_duration') }}" style="height:35px; width:90%;" >
            ...
            <div class="input-container1">
                <div style="width:80%;font-size:15px; color:#808080;text-decoration:bolder;">Opportunity Description:
                </div>
                <textarea rows="4" style="width:100%;" id="Brief_summary" name="Brief_summary"required="required"> {{ old('Brief_summary') }} </textarea>
            </div>
            @if($errors->has())
                <div class="error text-center" style="color:red;">
                    <ul>
