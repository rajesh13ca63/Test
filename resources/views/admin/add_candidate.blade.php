...
<div class="container1" style="margin-top:35px;background-color:#fff;">
    <div class="card1"></div>
        <div class="card1">  
            ...
            <form action="/admin/create/add_candidate" method="POST" class="form-horizontal form1"enctype="multipart/form-data">
                ...
                <div class="form-group" style="width:40%;margin-left:32px;font-size:15px; color:#808080;text-decoration:bolder;">
                    Date of Birth :<input type="date" name="Dob" value="{{ old('Dob') }}" style="color:black; background-color:pink"/>
                </div>
                @if($errors->has())
                    <div class="error text-center" style="color:red;">
                        <ul>
                ...
                <div class="form-group" style="width:80%;margin-left:32px;font-size:15px; text-decoration:bolder;">
                    <div style="text-decoration:bolder;color:#808080;"> Gender: </div>
                    <select name="Gender" id="male" value="{{ old('Gender') }}" style="height:40px; width:50%;" >
                        <option>Male</option>
                ...
                <div style="width:80%;margin:15px 0px 15px 32px;font-size:15px; text-decoration:bolder;">
                    <div style="text-decoration:bolder;color:#808080;">
                     ...
                     <select name="Type_opportunity" id="Consulting" value="{{ old('Type_opportunity') }}" style="height:40px; width:50%;" >
                ...
                <div class="input-container1">
                    <div style="width:80%;font-size:15px; color:#808080;text-decoration:bolder;"> Brief Profile:</div><textarea rows="4" style="width:100%;" id="Brief_profile" name="Brief_profile"required="required">{{ old('Brief_profile') }}</textarea>
                </div>
