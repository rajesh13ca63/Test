...
<div style="width:88%; background-color:#a0a0a0;margin-left:5%; margin-right:5%;margin-bottom:15px; font-size:0.93em;">
	...
	@if($uposts)
		...
		@foreach($uposts as $post)
			        ...
			        <div class="col-md-10 col-sm-12 col-md-6 col-lg-4 profile" >
						<div>
	...
	@endif
	<div class="row" ><div class="pagination" style="clear:both;float:right;margin-right:35px;"> {{  $uposts->render() }}</div></div>
