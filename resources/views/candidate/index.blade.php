...
<style type="text/css">
		...
		@foreach($jobs as $post)
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 profile" >
				<div>
					...
					<div style="width:100%; height:88px;margin-bottom:10px;" class="text-justify"><span class="sub_title"> Description :</span> {{ $post->Brief_summary }} </div> <br>
	...
	@if(count($jobs) == 0)
		<div style="width:100%;  height:300px;text-align:center; vertical-align:center;font-size:55px; padding:100px;color:red; font-weight:bold;"> No Records Found 
		</div>
	@endif
	<div class="row" ><div class="pagination" style="clear:both;float:right;margin-right:35px;"> {{  $mposts->render() }}</div></div>
	</div>
